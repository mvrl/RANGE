...
def main():
    ...
    plt.tight_layout()
    fig.savefig("/projects/bdec/adhakal2/hyper_satclip/data/eval_data/images/checkerboardsphere.pdf", transparent=True, bbox_inches="tight", pad_inches=0)
    fig.savefig("/projects/bdec/adhakal2/hyper_satclip/data/eval_data/images/checkerboardsphere.png", transparent=True, bbox_inches="tight", pad_inches=0)
    ...
    plt.tight_layout()
    fig.savefig("/projects/bdec/adhakal2/hyper_satclip/data/eval_data/images/checkerboardmap.pdf", transparent=True, bbox_inches="tight", pad_inches=0)
    fig.savefig("/projects/bdec/adhakal2/hyper_satclip/data/eval_data/images/checkerboardmap.png", transparent=True, bbox_inches="tight", pad_inches=0)
...
def resolution_deg(N):
    ...
    return np.rad2deg(np.sqrt(area_per_point(N, r=1) / np.pi))
...
def get_data(N_samples, N_support, n_classes, seed=0, grid=False, random_classes=False):
    ...
    return lonlats,torch.zeros_like(labels), labels
