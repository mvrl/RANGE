...
from .module import *
from .models import FCNet, LocationEncoder

from .data_utils import get_train_sample_ratio_tag
...
def make_model_file_param_args(params, spa_enc_type, get_unsuper_model_path  = False):
    ...
    if get_unsuper_model_path:
        ...
        train_sample_ratio_tag = get_train_sample_ratio_tag(params["train_sample_ratio"], params["train_sample_method"])
        if unsuper_loss == "none":
